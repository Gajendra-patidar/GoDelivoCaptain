...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 20, fontWeight: '800', color: '#fccf1e', marginTop: 12, textAlign: 'center' },
  heroSub: { fontSize: 13, color: '#fccf1e', textAlign: 'center', marginTop: 8, lineHeight: 20 },
  codeCard: {
  ...
  stepText: { fontSize: 13, color: '#6B7280', flex: 1, lineHeight: 19 },
  shareBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',

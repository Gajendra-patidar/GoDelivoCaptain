...
const styles = StyleSheet.create({
  ...
  summaryLabel: { fontSize: 13, color: '#fccf1e' },
  summaryAmount: { fontSize: 24, fontWeight: '800', color: '#fccf1e', marginTop: 2 },
  ...
  tipsTitle: { fontSize: 14, fontWeight: '700', color: '#fccf1e', marginBottom: 4 },
  tipsSub: { fontSize: 13, color: '#fccf1e', lineHeight: 19 },
});
